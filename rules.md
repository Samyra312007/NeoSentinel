Arm Create: AI Optimization Challenge (the “Hackathon”) Official Rules
...
1. Dates and Timing
Registration Period: Jun 10, 2026 (9:00 am Pacific Time) – Aug 14, 2026 (4:00 pm Pacific Time) (“Registration Period”).

Submission Period: Jun 10, 2026(9:00 am Pacific Time) – Aug 14, 2026 (4:00 pm Pacific Time) (“Submission Period”).

Judging Period: Aug 17, 2026 (9:00 am Pacific Time) – Sep 4, 2026(4:00 pm Pacific Time) (“Judging Period”).

Winners Announced: On or around Sep 15, 2026 (2:00 pm Pacific Time).

 
2. Sponsor and Administrator
Sponsor & Administrator: Arm,120 ROSE ORCHARD WAY, San Jose, CA 95134, United States 
...
Other (if your developer tools are only available in some countries or if there is a reason for limited eligibility, explain further.)  
...
4. How To Enter 
Entrants may enter by visiting arm-ai-optimization-challenge.devpost.com (“Hackathon Website”) and following the below steps:
...
Entrants must create, migrate, or optimize an AI solution on Arm architecture and fall within at least one of the three tracks below to complete a Project described below in Project Requirements. Use of the developer tools will be subject to the license agreement related thereto. Entry in the Hackathon constitutes consent for the Sponsor and Devpost to collect and maintain an entrant’s personal information for the purpose of operating and publicizing the Hackathon.
To create a free developer account with Arm AI, you need to sign up for the Arm Developer Program. This grants you a personalized dashboard, access to on-demand labs, technical support, and developer tools. 
Follow these steps to join:
Visit the Registration Page: Go to the Arm Developer Program Sign-Up Page.
Complete the Form: Fill out your entry form with your details, including your Name, Company, Email Address, and Job Title.
Verify Your Email: Enter the same email address you intend to use. You will receive an email with a verification code; enter it on the registration page to verify your account.
Complete Your Profile: Finish setting up your account (or update your existing profile if you already have an Arm ID) and click Join.
Access the Dashboard: Once finished, you can log in directly to your Arm Developer Dashboard.
...
What to Create: Entrants must create, migrate, or optimize an AI solution on Arm architecture and fall within at least one of these tracks (each a “Project”).  
Choose a Track: Each submission must clearly select one of the three tracks (Track 1, Track 2, or Track 3).
Track 1 Optimization output 
Each submission must include a copy of the project’s source code, either attached directly or linked to an open-source repository (e.g., GitHub).
Track 2 Migration/adoption value
Each submission must include a copy of the project’s source code, either attached directly or linked to an open-source repository (e.g., GitHub).
Track 3 Scale + learning completion for Source Code / Artifacts:
Each submission must include proof artifacts (links/screenshots) as described in the track requirements.
Project Write-Up: Along with source code or proof artifacts, a detailed write-up must be included. This write-up should cover:
...
Optional Media: Participants are encouraged to include an audio or video recording that explains or pitches the project. A clear demo can significantly help judges understand your work.
...
Stage Two) All Submissions that pass Stage One will be evaluated in Stage Two based on the following weighted criteria (the “Judging Criteria”):
...
Track alignment note: Judges may also consider whether the submission strongly meets the spirit of its selected track (optimization output for Track 1, migration/adoption value for Track 2, scale + learning completion for Track 3).
...
Featured blog post featuring winning submissions
